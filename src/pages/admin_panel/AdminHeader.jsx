    ...
    <div style={navigationStyle} className="navigation-panel">
      <nav>
        <ul className="link-list">
          <li>
            <Link to="/admin/add-book" style={linkStyle} activeStyle={linkHoverStyle}>
              Add Book
            </Link>
          </li>
          <li>
            <Link to="/admin/manage-std" style={linkStyle} activeStyle={linkHoverStyle}>
              Manage Students
            </Link>
          </li>
          <li>
            <Link to="/admin/issued-book" style={linkStyle} activeStyle={linkHoverStyle}>
              Issued Books
            </Link>
          </li>
          <li>
            <Link to="/admin/all-book" style={linkStyle} activeStyle={linkHoverStyle}>
              All Books
            </Link>
          </li>
          <li>
