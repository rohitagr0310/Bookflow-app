    ...
    <ThemeProvider theme={theme}>
      <div className={classes.root} style={{ backgroundImage: `url(${backgroundImage})` }}>
        ...
        <Container maxWidth="lg" className={classes.container}>
          ...
          <Typography variant="body1" className={classes.contentText} style={{ fontSize: 20 }} paragraph>
          ...
          <section className={classes.section}>
            ...
            <Typography variant="body1" className={classes.sectionContent} style={{ fontSize: 20 }} paragraph>
          ...
          <section className={classes.section}>
            ...
            <Typography className={classes.sectionContent} style={{ fontSize: 20 }}>
          ...
          <section className={classes.section}>
            ...
            <div className={classes.testimonialCards}>
              <Card className={classes.testimonialCard} style={{ backgroundColor: "#BCEAD5", fontStyle: "italic" }}>
                <CardContent>
